...
public class statement_getWarnings_return implements org.apache.thrift.TBase<statement_getWarnings_return, statement_getWarnings_return._Fields>, java.io.Serializable, Cloneable, Comparable<statement_getWarnings_return> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new statement_getWarnings_returnStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new statement_getWarnings_returnTupleSchemeFactory();

  public java.util.List<SupersqlWarning> warnings; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WARNINGS, new org.apache.thrift.meta_data.FieldMetaData("warnings", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SupersqlWarning.class))));
  ...
  public statement_getWarnings_return(
    java.util.List<SupersqlWarning> warnings)
  {
    this();
  ...
  public statement_getWarnings_return(statement_getWarnings_return other) {
    if (other.isSetWarnings()) {
      java.util.List<SupersqlWarning> __this__warnings = new java.util.ArrayList<SupersqlWarning>(other.warnings.size());
      for (SupersqlWarning other_element : other.warnings) {
        __this__warnings.add(new SupersqlWarning(other_element));
      }
  ...
  public java.util.Iterator<SupersqlWarning> getWarningsIterator() {
    return (this.warnings == null) ? null : this.warnings.iterator();
  }

  public void addToWarnings(SupersqlWarning elem) {
    if (this.warnings == null) {
      this.warnings = new java.util.ArrayList<SupersqlWarning>();
    }
    this.warnings.add(elem);
  }

  public java.util.List<SupersqlWarning> getWarnings() {
    return this.warnings;
  }

  public statement_getWarnings_return setWarnings(java.util.List<SupersqlWarning> warnings) {
    this.warnings = warnings;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WARNINGS:
      if (value == null) {
        ...
        setWarnings((java.util.List<SupersqlWarning>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("statement_getWarnings_return(");
    boolean first = true;
  ...
  private static class statement_getWarnings_returnStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public statement_getWarnings_returnStandardScheme getScheme() {
      return new statement_getWarnings_returnStandardScheme();
    }
  }

  private static class statement_getWarnings_returnStandardScheme extends org.apache.thrift.scheme.StandardScheme<statement_getWarnings_return> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.warnings = new java.util.ArrayList<SupersqlWarning>(_list24.size);
                SupersqlWarning _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new SupersqlWarning();
                  _elem25.read(iprot);
                  struct.warnings.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, statement_getWarnings_return struct) throws org.apache.thrift.TException {
      ...
      if (struct.warnings != null) {
        oprot.writeFieldBegin(WARNINGS_FIELD_DESC);
        {
          ...
          for (SupersqlWarning _iter27 : struct.warnings)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class statement_getWarnings_returnTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public statement_getWarnings_returnTupleScheme getScheme() {
      return new statement_getWarnings_returnTupleScheme();
    }
  }

  private static class statement_getWarnings_returnTupleScheme extends org.apache.thrift.scheme.TupleScheme<statement_getWarnings_return> {
      ...
      if (struct.isSetWarnings()) {
        {
          ...
          for (SupersqlWarning _iter28 : struct.warnings)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.warnings = new java.util.ArrayList<SupersqlWarning>(_list29.size);
          SupersqlWarning _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new SupersqlWarning();
            _elem30.read(iprot);
            struct.warnings.add(_elem30);
          }
        }
        struct.setWarningsIsSet(true);
      }
