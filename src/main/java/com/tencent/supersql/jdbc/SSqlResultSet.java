...
import com.tencent.supersql.gen.SupersqlValue;
 ...
 */
public class SSqlResultSet implements ResultSet {

    private SupersqlResultSet resultset;

    private SSqlResultSetMetaData metadata;

    private SSqlStatement statement;
    ...
    private SupersqlResultSet supersqlResultSet = null;
    public SSqlResultSet(SupersqlResultSet supersqlResultSet){

        this.resultset = supersqlResultSet;
        this.metadata = new SSqlResultSetMetaData(this.resultset.metadata);
        this.rowIndex = 0;

        this.supersqlResultSet = supersqlResultSet;
    }
    ...
    private SupersqlValue getColumnValue(int columnIndex) throws SQLException {
    ...
    public String getString(int columnIndex) throws SQLException {
        ...
        SupersqlValue value = getColumnValue(columnIndex);
        if (value.isnull) {
            this.wasNull = true;
            return null;
        } else {
    ...
    private SupersqlValue getCCValue(int columnIndex) {
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        ...
        try {
            SupersqlValue val = getCCValue(columnIndex);
            if (val.isnull) {
                this.wasNull = true;
                return false;
